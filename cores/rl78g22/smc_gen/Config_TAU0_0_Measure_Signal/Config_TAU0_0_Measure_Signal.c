...
{
    R_Config_TAU0_0_Measure_Signal_Create();
    R_Config_TAU0_5_Measure_Signal_Create();
}

void R_Config_TAU0_0_6_Measure_Signal_Create(void)
{
    R_Config_TAU0_0_Measure_Signal_Create();
    R_Config_TAU0_6_Measure_Signal_Create();
}
*/
...
void R_Config_TAU0_0_6_Measure_Signal_Stop(void)
{
    ...
    TMIF00 = 0U;    /* clear INTTM00 interrupt flag */
    TMIF06 = 0U;    /* clear INTTM06 interrupt flag */
    TT0 |= (_0001_TAU_CH0_STOP_TRG_ON | _0040_TAU_CH6_STOP_TRG_ON);
}
...
void R_Config_TAU0_0_7_Measure_Signal_Stop(void)
{
    ...
    TMIF00 = 0U;    /* clear INTTM00 interrupt flag */
    TMIF07 = 0U;    /* clear INTTM07 interrupt flag */
    TT0 |= (_0001_TAU_CH0_STOP_TRG_ON | _0080_TAU_CH7_STOP_TRG_ON);
}
/* 1124 nhu add */
