...
/***********************************************************************************************************************
* File Name    : Config_TAU0_7_MSTimer2.c
* Version      : 1.1.0
...
* Description  : This function initializes the TAU0 channel 7 module.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_TAU0_7_MSTimer2_Create(void)
{
...
//    TDR07 = 0x13F;
    ...
    R_Config_TAU0_7_MSTimer2_Create_UserInit();
}

/***********************************************************************************************************************
* Function Name: R_Config_TAU0_7_Start
* Description  : This function starts the TAU0 channel 7 counter.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_TAU0_7_MSTimer2_Start(void)
{
    TMIF07 = 0U;    /* clear INTTM07 interrupt flag */
...
* Description  : This function stops the TAU0 channel 7 counter.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void R_Config_TAU0_7_MSTimer2_Stop(void)
{
    TT0 |= _0080_TAU_CH7_STOP_TRG_ON;
    /* Mask channel 7 interrupt */
    TMMK07 = 1U;    /* disable INTTM07 interrupt */
...
void R_Config_TAU0_7_MSTimer2_SetPeriod(uint16_t preiod_us)
{
    TDR07 = 32 * preiod_us -1;
}
/* End user code. Do not edit comment generated here */
