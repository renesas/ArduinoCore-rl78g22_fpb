...
#define _50_ITL_CLOCK_FITL1_ELC                           (0x50U)    /* event input from the ELC */
...
#define _05_ITL_CLOCK_FITL0_ELC                           (0x05U)    /* event input from the ELC */
...
#define _03_ITL_CAPTURE_TRIGGER_ELC                       (0x03U)    /* event input from ELC (rising edge) */
