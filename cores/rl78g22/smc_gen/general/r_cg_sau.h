...
*/
/* Selection of enable or disable the generation of communication error interrupts in the SNOOZE mode (SSEC0) */
#define _0000_SAU_CH0_SNOOZE_INT_ENABLE  (0x0000U)    /* enable the generation of error interrupts (INTSRE0) */
#define _0002_SAU_CH0_SNOOZE_INT_DISABLE (0x0002U)    /* disable the generation of error interrupts (INTSRE0) */
/* Setting of the SNOOZE mode (SWC0) */
...
*/
/* Switch of the serial clock input source of CSI01 (ISC7 - ISC6) */
#define _00_CSI01_INPUT_SCK01_PIN        (0x00U)    /* input signal of the SCK01 pin (normal operation) */
#define _80_CSI01_INPUT_TO01_PIN         (0x80U)    /* TO01 output signal */
#define _3F_CSI01_INPUT_CLEAR            (0x3FU)    /* clear ISC7-ISC6 bit */
/* Switch of the serial clock input source of CSI00 (ISC4 - ISC3) */
#define _00_CSI00_INPUT_SCK00_PIN        (0x00U)    /* input signal of the SCK00 pin (normal operation) */
#define _10_CSI00_INPUT_TO01_PIN         (0x10U)    /* TO01 output signal */
#define _E7_CSI00_INPUT_CLEAR            (0xE7U)    /* clear ISC4-ISC3 bit */
/* Switching channel 7 input of timer array unit (ISC1) */
#define _00_TAU07_INPUT_TI07_PIN         (0x00U)    /* uses the input signal of the TI07 pin as a timer input
                                                       (normal operation) */
#define _02_TAU07_INPUT_RXD2_PIN         (0x02U)    /* input signal of the RxD2 pin is used as timer input */
/* Switching external interrupt (INTP0) input (ISC0) */
#define _00_INTP0_INPUT_INTP0_PIN        (0x00U)    /* uses the input signal of the INTP0 pin as an external interrupt
                                                       (normal operation) */
#define _01_INTP0_INPUT_RXD2_PIN         (0x01U)    /* uses the input signal of the RxD2 pin as an external interrupt
