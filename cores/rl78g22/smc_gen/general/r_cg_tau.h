...
#define _0800_TAU_COMBINATION_MASTER      (0x0800U)    /* channel 2, 4, 6 operates as master channel */
...
#define _01_TAU_CH5_INPUT_ELC             (0x01U)    /* input signal of ELC */
...
#define _02_TAU_CH1_INPUT_ELC             (0x02U)    /* input signal of ELC */
...
#define _01_TAU_CH0_INPUT_ELC             (0x01U)    /* input signal of ELC */
...
#define _00_TAU_CH7_INPUT_TI07            (0x00U)    /* input signal of TI07 pin is used as timer input */
#define _02_TAU_CH7_INPUT_RXD2            (0x02U)    /* input signal of RxD2 pin is used as timer input */
#define _FD_TAU_CH7_INPUT_CLEAR           (0xFDU)    /* channel 7 input clear */
...
#define _01_EXTERNAL_INPUT_RXD2           (0x01U)    /* input signal of RxD2 pin is used as external interrupt input */
