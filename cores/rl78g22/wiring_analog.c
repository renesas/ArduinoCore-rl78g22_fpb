...
// const uint8_t  pwm_channel_table[PWM_CH_NUM]  = {PWM_PIN_10,PWM_PIN_12,PWM_PIN_24,PWM_PIN_6};
const uint8_t  pwm_channel_table[PWM_CH_NUM]  = {10,3,5};
...
const uint8_t g_analog_pin_input[NUM_ANALOG_INPUTS] = {A0, A1, A2, A3, A4, A5, A6, A7
//        , A8, A9
};
...
//    pwm_ch[0].cycle = _analogFrequency(PWM_PIN_10,Hz);
//    pwm_ch[1].cycle = _analogFrequency(PWM_PIN_12,Hz);
//    pwm_ch[2].cycle = _analogFrequency(PWM_PIN_24,Hz);
//    pwm_ch[3].cycle = _analogFrequency(PWM_PIN_6,Hz);
