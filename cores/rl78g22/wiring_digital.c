...
// 2022/11/16 added by KAD follow the FPB manual instruction.
//        	ignore the output instruction to P23(IO43), P24(IO42), P25(IO41), P26(IO40), P21(IO27), P30(IO8) and P20(IO35)
#ifdef G22_FPB
            if((pin==43) || (pin==42) || (pin==41) || (pin==40) || (pin==27) || (pin==8) || (pin==35) )
            {
                break;
            }
#endif
