...
// 2022/11/11 temporary KAD
// const uint8_t  tone_channel_table[TONE_CH_NUM]  = {PWM_PIN_10,PWM_PIN_12,PWM_PIN_24,PWM_PIN_6};
const uint8_t  tone_channel_table[TONE_CH_NUM]  = {10,9,3,5};
