...
volatile unsigned short *g_timer_period_reg[PWM_CH_NUM] = {&TDR00,&TDR02,&TDR06};
volatile unsigned short *g_timer_duty_reg[PWM_CH_NUM]   = {&TDR01,&TDR03,&TDR07};
volatile unsigned short *g_timer_analog_mode_reg[PWM_CH_NUM] = {&TMR01,&TMR03,&TMR07};
volatile unsigned short *g_timer_analog_clock_select_reg = &TPS0;
const uint8_t  pwm_channel_table[PWM_CH_NUM]  = {PWM_PIN_10,PWM_PIN_3,PWM_PIN_5};
...
{
    {
        .open  = R_Config_TAU0_01_PWM_Create,
        .start = R_Config_TAU0_01_PWM_Start,
        .cycle = CYCLE_VALUE,
    },
    {
        .open  = R_Config_TAU0_23_PWM_Create,
        .start = R_Config_TAU0_23_PWM_Start,
        .cycle = CYCLE_VALUE,
    },
	{
        .open  = R_Config_TAU0_67_PWM_Create,
        .start = R_Config_TAU0_67_PWM_Start,
        .cycle = CYCLE_VALUE,
    }
};
...
volatile unsigned short *g_timer_pulse_mode_reg[PULSE_IN_CH_NUM] = {&TMR01,&TMR02,&TMR03,&TMR07};
...
const uint8_t  pulse_in_channel_table[PULSE_IN_CH_NUM]  = {PWM_PIN_10,PWM_PIN_9,PWM_PIN_3,PWM_PIN_5};
